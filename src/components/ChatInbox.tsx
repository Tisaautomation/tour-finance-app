                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start">
                      <span className={`font-semibold truncate ${selectedConversation?.id === conv.id ? 'text-white' : 'text-gray-800'}`}>
                    ...
                    <p className={`text-sm truncate mt-1 ${selectedConversation?.id === conv.id ? 'text-white/80' : 'text-gray-500'}`}>
